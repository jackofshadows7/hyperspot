...
use crate::contract::{error::UsersInfoError, model::{NewUser, User, UserPatch}};
...
pub trait UsersInfoApi: Send + Sync {
    ...
    async fn list_users(&self, limit: Option<u32>, offset: Option<u32>) -> Result<Vec<User>, UsersInfoError>;
